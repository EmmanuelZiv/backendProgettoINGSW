...
public class Asta_allingleseController {
    ...
    public Long insertAstaInglese(@RequestBody Asta_allinglese_DTO asta_inglese_dto, @PathVariable(value = "lista_categorie", required = false) ArrayList<String> lista_categorie,@PathVariable(value = "asta_inglese") Asta_allinglese_DTO asta_inglese){
        try{
